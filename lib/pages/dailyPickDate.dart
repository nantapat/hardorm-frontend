...
class DailyPickDate extends StatefulWidget {
  @override
  _DailyPickDateState createState() => _DailyPickDateState();
}

class _DailyPickDateState extends State<DailyPickDate> {
                ...
                children: <Widget>[
                  ...
                  Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          'Check out :  ${DateFormat('MM/dd/yyyy').format(_endDate).toString()}',
                          style: TextStyle(
                            fontSize: 14.0,
                            fontWeight: FontWeight.bold,
                          ),
